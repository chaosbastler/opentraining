 ...
 * 
 */
public class DownloadExercisesActivity extends Activity {
	/** Tag for logging */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.download_exercises);
	...
	private void startDownload() {
		...
		if (!isOnline()) {
			AlertDialog.Builder builder = new AlertDialog.Builder(DownloadExercisesActivity.this);
	...
	public boolean download(String urlString) {
		...
		DataManager.INSTANCE.loadExercises(DownloadExercisesActivity.this);
