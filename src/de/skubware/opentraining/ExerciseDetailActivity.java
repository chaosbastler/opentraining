...
/**
 * Activity to start {@link ExerciseDetailFragment}. Most code here
 * auto-generated by template of eclipse.
 * 
 */
public class ExerciseDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(ExerciseDetailFragment.ARG_ITEM_ID, getIntent().getStringExtra(ExerciseDetailFragment.ARG_ITEM_ID));
